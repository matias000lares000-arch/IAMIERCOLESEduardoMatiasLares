...
st.set_page_config(page_title="Mi chat de Eduardo matias", page_icon="👍")
st.title("Mi primera aplicacion con Streamlit Eduardo Matias")
...
# modelo = configurar_pagina()
# mensaje = st.chat_imput("Escribi tu mensaje")

# correr streamlit con la terminal python
# python -m run MiChat.py (aca deben ingresar el nombre del archivo)
